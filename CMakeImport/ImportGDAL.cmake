...
find_path(${LIBRARYNAME}_LIBRARY_INCLUDE_PATH
    NAME gdal.h
    PATHS "/usr/include/gdal" NO_DEFAULT_PATH)
...
message(STATUS "Found GDAL include: ${${LIBRARYNAME}_LIBRARY_INCLUDE_PATH}")
message(STATUS "Found GDAL lib: ${${LIBRARYNAME}_LIBRARY_RELEASE_NAME}")
message(STATUS "Found GDAL DEB: ${${LIBRARYNAME}_LIBRARY_DEBUG_NAME}")
